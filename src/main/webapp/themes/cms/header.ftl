...
<html lang="en">
  <head>
    ...
    <link href="${TEMPLATE_PATH}/css/theme.css" rel="stylesheet">
     <link href="${TEMPLATE_PATH}/css/cc.css" rel="stylesheet">
	...
	#nav{width:1000px;height:99px;background:url(upload/head/nav.png);margin:0px auto;color:#fff;}
  ...
  <body>
  	<header class="header-frontend">
        ...
        <div id="nav">
  		<ul>
      	<li><a href="index.asp"   class="navcur">首页</a>|</li>
    	<li><a href="about.asp"   class="w">关于FORKISS</a>|</li>
    	<li><a href="news.asp"   class="w">FORKISS动态</a>|</li>
    	<li><a href="course.asp"   class="w">FORKISS课程表</a>|</li>
    	<li><a href="share.asp"    class="w">会员分享</a>|</li>
   		<li><a href="baike.asp"   class="w">孕育百科</a>|</li>
    	<li><a href="school.asp"   class="w">FORKISS学院</a></li>
  		</ul>
	</div>
    </header>